...
public abstract class AbstractApplicationContext extends DefaultResourceLoader implements ConfigurableApplicationContext {
    ...
    public void refresh() throws BeansException {
        ...
        // 3. 添加ApplicationContextAwareProcessor，让继承自ApplicationContextAware 的 Bean 对象都能感知所属的 ApplicationContext
    ...
    private void registerListeners() {
        ...
        for (ApplicationListener listener : applicationListeners) {
            applicationEventMulticaster.addApplicaitonListener(listener);
        }
    }
    ...
    public void publishEvent(ApplicationEvent event) {
        applicationEventMulticaster.muticastEvent(event);
    }
